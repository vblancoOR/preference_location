# -*- coding: utf-8 -*-
"""
Created on Tue Dec 17 10:20:46 2024
...
def gen_parameters(A,R,Norms2,ff,nfactors,sed):
    """
    ...
    nfactors : int with the number of factors for the preference functions based on production models.
    ...
    if ff == "L":
        ...
        ## Se puede seleccionar los factores que se quiera siempre y cuando la beta elegida admita descomposición BEP.
        ## al final del código puedes ver aquellos beta que tienen dicha descomposición.
        ...
        for i in N:
            ...
            for j in Nfactors:
                for l in range(CS[i][j][1]):
                    #### Le doy valor random a cada una de las regiones.
